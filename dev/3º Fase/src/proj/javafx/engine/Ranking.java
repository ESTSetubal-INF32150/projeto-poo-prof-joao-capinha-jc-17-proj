...
public class Ranking {
    ...
    public ArrayList<Player> getRankingOrdened() {
        orderByUserMax(this.ranking);
    ...
    public void saveRanking(ArrayList<Player> ranking) {
        String path = "././src/proj/javafx/saves";
    ...
    public static ArrayList<Player> loadRanking() {
        File f = new File("././src/proj/javafx/saves/");
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        ...
        if (f.exists()) {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
                ...
                if (str.endsWith(".save")) {
                    File file = new File("././src/proj/javafx/saves/" + str);
